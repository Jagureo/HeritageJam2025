...
@onready var passenger_type_label : Label = $Panel/Passenger_Type
@onready var passenger_trait_label : Label = $Panel/Passenger_Trait
@onready var passenger_gender_label : Label = $Panel/Passenger_Gender
